...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-blue-50 to-gray-100 md:flex md:flex-col  md:justify-center md:items-center relative overflow-hidden">
