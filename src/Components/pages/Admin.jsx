    ...
    <div className="w-full h-screen bg-gray-100 flex">
      ...
      <div className="w-64 bg-white shadow-md h-full">
        ...
        <nav className="mt-4 snap-y">
          ...
          <div className="px-4 py-3 flex items-center space-x-3 text-gray-500 cursor-pointer" onClick={() => setActiveTab("driver")}  title="Driver Management">
          ...
          <div className="px-4 py-3 flex items-center space-x-3 text-gray-500 cursor-pointer" onClick={() => setActiveTab("fleet")} title="Fleet Management">
            <div className="w-6 h-6 rounded-md flex items-center justify-center">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="px-4 py-3 flex items-center space-x-3 text-gray-500 cursor-pointer" onClick={() => setActiveTab("payment")} title="Payment & Transactions">
            <div className="w-6 h-6 rounded-md flex items-center justify-center">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="px-4 py-3 flex items-center space-x-3 text-gray-500 cursor-pointer" onClick={() => setActiveTab("customer")} title="Customer Management">
            <div className="w-6 h-6 rounded-md flex items-center justify-center">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 10h16M4 14h16M4 18h16" />
              </svg>
          ...
          <div className="px-4 py-3 flex items-center space-x-3 text-gray-500 cursor-pointer" onClick={() => setActiveTab("report")} title="Reports & Logs ">
            <div className="w-6 h-6 rounded-md flex items-center justify-center">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 10h16M4 14h16M4 18h16" />
              </svg>
          ...
          <div className="px-4 py-3 flex items-center space-x-3 text-gray-500 cursor-pointer" onClick={() => setActiveTab("message")} title="Messages">
            <div className="w-6 h-6 rounded-md flex items-center justify-center">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
